#
#  Be sure to run `pod spec lint stream-analytics-ios.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of stream-analytics-ios in Markdown format.
  ...
  # Or just: s.author    = "Stream"
  # s.authors            = { "Stream" => "support@getstream.io" }
  # s.social_media_url   = "http://twitter.com/Stream"
